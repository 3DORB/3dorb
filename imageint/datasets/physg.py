from imageint.third_party.physg.code.datasets.scene_dataset import SceneDataset
from imageint.utils.colmap.read_write_model import read_model, read_cameras_binary, read_images_binary
from imageint.constant import BENCHMARK_RESOLUTION
from imageint.utils.preprocess import load_mask_png, load_rgb_exr
import numpy as np
from imageint.utils.colmap.nerfplusplus_normalize_cam_dict import _normalize_cam_dict
import torch
...
def preprocess_cameras_core(base_dir):
    sparse_dir = os.path.join(base_dir, 'sparse/0')
